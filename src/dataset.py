...
class D4rlDataset(Dataset):
  ...
  def __init__(self,
    ...
    new_trajectory = True
    print(f'Shape d4rl observations {d4rl_dataset["observations"].shape}')
    print(f'Shape d4rl actions {d4rl_dataset["actions"].shape}')
    print(f'Shape d4rl rewards {d4rl_dataset["rewards"].shape}')
    print(f'Shape d4rl terminals {d4rl_dataset["terminals"].shape}')
